...
truncate table "ohdsi"."drug_strength" cascade;
truncate table "ohdsi"."concept_relationship" cascade;
truncate table "ohdsi"."relationship" cascade;
truncate table "ohdsi"."concept_ancestor" cascade;
truncate table "ohdsi"."vocabulary" cascade;
truncate table "ohdsi"."concept" cascade;
truncate table "ohdsi"."concept_class" cascade;
truncate table "ohdsi"."domain" cascade;

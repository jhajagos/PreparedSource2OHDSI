...
truncate table [dbo].[drug_strength] cascade;
truncate table [dbo].[concept_relationship] cascade;
truncate table [dbo].[relationship] cascade;
truncate table [dbo].[concept_ancestor] cascade;
truncate table [dbo].[vocabulary] cascade;
truncate table [dbo].[concept] cascade;
truncate table [dbo].[concept_class] cascade;
truncate table [dbo].[domain] cascade;
...
alter table [dbo].[visit_occurrence] alter column [visit_source_value] VARCHAR(512);
...
alter table [dbo].[condition_occurrence] alter column [stop_reason] VARCHAR(512);
...
alter table [dbo].[drug_exposure] alter column [stop_reason] VARCHAR(512);

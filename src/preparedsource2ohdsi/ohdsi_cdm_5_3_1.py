...
class OHDSI531OutputClass(OHDSIOutputClass):
    """Child Class 5.3.1"""
...
class AttributeDefinitionObject(OHDSI531OutputClass):
    def table_name(self):
    ...
    def _data_types(self):
        return {"attribute_definition_id": "INTEGER", "attribute_name": "VARCHAR(255)", "attribute_description": "STRING", "attribute_type_concept_id": "INTEGER", "attribute_syntax": "STRING"}


class CareSiteObject(OHDSI531OutputClass):
    def table_name(self):
        return "care_site"
...
class CdmSourceObject(OHDSI531OutputClass):
    def table_name(self):
        return "cdm_source"
    ...
    def _data_types(self):
        return {"cdm_source_name": "VARCHAR(255)", "cdm_source_abbreviation": "VARCHAR(25)", "cdm_holder": "VARCHAR(255)", "source_description": "STRING", "source_documentation_reference": "VARCHAR(255)", "cdm_etl_reference": "VARCHAR(255)", "source_release_date": "DATE", "cdm_release_date": "DATE", "cdm_version": "VARCHAR(10)", "vocabulary_version": "VARCHAR(20)"}


class CohortDefinitionObject(OHDSI531OutputClass):
    def table_name(self):
...
class ConceptObject(OHDSI531OutputClass):
    def table_name(self):
        return "concept"
...
class ConceptAncestorObject(OHDSI531OutputClass):
    def table_name(self):
...
class ConceptClassObject(OHDSI531OutputClass):
    def table_name(self):
...
class ConceptRelationshipObject(OHDSI531OutputClass):
    def table_name(self):
...
class ConceptSynonymObject(OHDSI531OutputClass):
    def table_name(self):
...
class ConditionEraObject(OHDSI531OutputClass):
    def table_name(self):
...
class ConditionOccurrenceObject(OHDSI531OutputClass):
    def table_name(self):
...
class CostObject(OHDSI531OutputClass):
    def table_name(self):
        return "cost"
...
class DeathObject(OHDSI531OutputClass):
    def table_name(self):
        return "death"
...
class DeviceExposureObject(OHDSI531OutputClass):
    def table_name(self):
    ...
    def _data_types(self):
        return {"device_exposure_id": "INTEGER", "person_id": "INTEGER", "device_concept_id": "INTEGER", "device_exposure_start_date": "DATE", "device_exposure_start_datetime": "TIMESTAMP", "device_exposure_end_date": "DATE", "device_exposure_end_datetime": "TIMESTAMP", "device_type_concept_id": "INTEGER", "unique_device_id": "VARCHAR(50)", "quantity": "INTEGER", "provider_id": "INTEGER", "visit_occurrence_id": "INTEGER", "visit_detail_id": "INTEGER", "device_source_value": "VARCHAR(50)", "device_source_concept_id": "INTEGER"}


class DomainObject(OHDSI531OutputClass):
    def table_name(self):
        return "domain"
...
class DoseEraObject(OHDSI531OutputClass):
    def table_name(self):
        return "dose_era"
...
class DrugEraObject(OHDSI531OutputClass):
    def table_name(self):
        return "drug_era"
...
class DrugExposureObject(OHDSI531OutputClass):
    def table_name(self):
...
class DrugStrengthObject(OHDSI531OutputClass):
    def table_name(self):
...
class FactRelationshipObject(OHDSI531OutputClass):
    def table_name(self):
...
class LocationObject(OHDSI531OutputClass):
    def table_name(self):
        return "location"
    ...
    def _data_types(self):
        return {"location_id": "INTEGER", "address_1": "VARCHAR(50)", "address_2": "VARCHAR(50)", "city": "VARCHAR(50)", "state": "VARCHAR(2)", "zip": "VARCHAR(9)", "county": "VARCHAR(20)", "location_source_value": "VARCHAR(50)"}


class MeasurementObject(OHDSI531OutputClass):
    def table_name(self):
        return "measurement"
    ...
    def _data_types(self):
        return {"measurement_id": "INTEGER", "person_id": "INTEGER", "measurement_concept_id": "INTEGER", "measurement_date": "DATE", "measurement_datetime": "TIMESTAMP", "measurement_time": "VARCHAR(10)", "measurement_type_concept_id": "INTEGER", "operator_concept_id": "INTEGER", "value_as_number": "NUMERIC", "value_as_concept_id": "INTEGER", "unit_concept_id": "INTEGER", "range_low": "NUMERIC", "range_high": "NUMERIC", "provider_id": "INTEGER", "visit_occurrence_id": "INTEGER", "visit_detail_id": "INTEGER", "measurement_source_value": "VARCHAR(50)", "measurement_source_concept_id": "INTEGER", "unit_source_value": "VARCHAR(50)", "value_source_value": "VARCHAR(50)"}


class MetadataObject(OHDSI531OutputClass):
    def table_name(self):
        return "metadata"

    def _fields(self):
        return ["metadata_concept_id", "metadata_type_concept_id", "name", "value_as_string", "value_as_concept_id", "metadata_date", "metadata_datetime"]

    def _data_types(self):
        return {"metadata_concept_id": "INTEGER", "metadata_type_concept_id": "INTEGER", "name": "VARCHAR(250)", "value_as_string": "VARCHAR(250)", "value_as_concept_id": "INTEGER", "metadata_date": "DATE", "metadata_datetime": "TIMESTAMP"}


class NoteObject(OHDSI531OutputClass):
    def table_name(self):
        return "note"

    def _fields(self):
        return ["note_id", "person_id", "note_date", "note_datetime", "note_type_concept_id", "note_class_concept_id", "note_title", "note_text", "encoding_concept_id", "language_concept_id", "provider_id", "visit_occurrence_id", "visit_detail_id", "note_source_value"]

    def _data_types(self):
        return {"note_id": "INTEGER", "person_id": "INTEGER", "note_date": "DATE", "note_datetime": "TIMESTAMP", "note_type_concept_id": "INTEGER", "note_class_concept_id": "INTEGER", "note_title": "VARCHAR(250)", "note_text": "STRING", "encoding_concept_id": "INTEGER", "language_concept_id": "INTEGER", "provider_id": "INTEGER", "visit_occurrence_id": "INTEGER", "visit_detail_id": "INTEGER", "note_source_value": "VARCHAR(50)"}


class NoteNlpObject(OHDSI531OutputClass):
    def table_name(self):
        return "note_nlp"
...
class ObservationObject(OHDSI531OutputClass):
    def table_name(self):
        return "observation"
...
class PayerPlanPeriodObject(OHDSI531OutputClass):
    def table_name(self):
...
class PersonObject(OHDSI531OutputClass):
    def table_name(self):
        return "person"
...
class ProcedureOccurrenceObject(OHDSI531OutputClass):
    def table_name(self):
        return "procedure_occurrence"

    def _fields(self):
        return ["procedure_occurrence_id", "person_id", "procedure_concept_id", "procedure_date", "procedure_datetime", "procedure_type_concept_id", "modifier_concept_id", "quantity", "provider_id", "visit_occurrence_id", "visit_detail_id", "procedure_source_value", "procedure_source_concept_id", "modifier_source_value"]

    def _data_types(self):
        return {"procedure_occurrence_id": "INTEGER", "person_id": "INTEGER", "procedure_concept_id": "INTEGER", "procedure_date": "DATE", "procedure_datetime": "TIMESTAMP", "procedure_type_concept_id": "INTEGER", "modifier_concept_id": "INTEGER", "quantity": "INTEGER", "provider_id": "INTEGER", "visit_occurrence_id": "INTEGER", "visit_detail_id": "INTEGER", "procedure_source_value": "VARCHAR(50)", "procedure_source_concept_id": "INTEGER", "modifier_source_value": "VARCHAR(50)"}


class ProviderObject(OHDSI531OutputClass):
    def table_name(self):
        return "provider"
...
class RelationshipObject(OHDSI531OutputClass):
    def table_name(self):
        return "relationship"
...
class SourceToConceptMapObject(OHDSI531OutputClass):
    def table_name(self):
...
class SpecimenObject(OHDSI531OutputClass):
    def table_name(self):
        return "specimen"
...
class VisitDetailObject(OHDSI531OutputClass):
    def table_name(self):
        return "visit_detail"
    ...
    def _data_types(self):
        return {"visit_detail_id": "INTEGER", "person_id": "INTEGER", "visit_detail_concept_id": "INTEGER", "visit_detail_start_date": "DATE", "visit_detail_start_datetime": "TIMESTAMP", "visit_detail_end_date": "DATE", "visit_detail_end_datetime": "TIMESTAMP", "visit_detail_type_concept_id": "INTEGER", "provider_id": "INTEGER", "care_site_id": "INTEGER", "visit_detail_source_value": "VARCHAR(50)", "visit_detail_source_concept_id": "INTEGER", "admitting_source_value": "VARCHAR(50)", "admitting_source_concept_id": "INTEGER", "discharge_to_source_value": "VARCHAR(50)", "discharge_to_concept_id": "INTEGER", "preceding_visit_detail_id": "INTEGER", "visit_detail_parent_id": "INTEGER", "visit_occurrence_id": "INTEGER"}


class VisitOccurrenceObject(OHDSI531OutputClass):
    def table_name(self):
